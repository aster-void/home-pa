...
import type { Gap, LocationLabel, LocationPreference, Suggestion } from "../../types.js";
 ...
 */
const LOCATION_COMPATIBILITY: Record<LocationPreference, Set<LocationLabel | undefined>> = {
 ...
 * }
 */
export function canFitInGap(suggestion: Suggestion, gap: Gap): CompatibilityResult {
 ...
 */
export function findFirstCompatibleGap(suggestion: Suggestion, gaps: Gap[]): Gap | undefined {
